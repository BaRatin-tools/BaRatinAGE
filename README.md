...
- sur windows, à la racine du dossier contenant BaRatinAGE que vous venez de décompresser, il vous suffit de double-cliquer sur l'executable nommé **BaRatinAGE.exe** qui s'y trouve.
- sur linux, dans le sous dossier `bin\` du dossier contenant BaRatinAGE que vous venez de décompresser,il vous suffit de double-cliquer sur l'executable nommé **BaRatinAGE** qui s'y trouve (ou de le lancer en ligne de commande: `./BaRatinAGE`).
...
Sinon, vous pouvez nous envoyer un mail à l'adresse **baratin.dev [at] inrae.fr**.
...
Vous pouvez envoyer vos contributions en ouvrant une nouvelle _issue_ sur Github (`New Issue` sur la page [https://github.com/BaRatin-tools/BaRatinAGE/issues](https://github.com/BaRatin-tools/BaRatinAGE/issues), nécéssite un compte Github) ou par email à l'adresse **baratin.dev [at] inrae.fr**.
...
For example, for Windows and version 2.2, got to the section **BaRatinAGE 2.2** and click on **BaRatinAGE_v2.2_windows.zip** to download the archive.
...
The best way to do so is to have a Guthub account and open a new _issue_ by clicking `New Issue` on the page [https://github.com/BaRatin-tools/BaRatinAGE/issues](https://github.com/BaRatin-tools/BaRatinAGE/issues).
