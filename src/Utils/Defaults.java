...
public class Defaults {
	...
	public static final Color plot_kColor_light = new Color(56, 255, 83);
	public static final Color plot_kColor = new Color(12, 51, 12);

	// public static final Color plot_kPriorColor_light = new Color(0.8f, 0.0f,
	// 0.8f);
	// public static final Color plot_kPriorColor = new Color(0.5f, 0.0f, 0.5f);
	public static final Color plot_kPriorColor_light = new Color(255, 67, 255);
	public static final Color plot_kPriorColor = new Color(62, 17, 62);
	...
	// public static final String helpDir_fr= new
	// File(home,"aide").getAbsolutePath();
	// public static final String helpDir_en= new
	// File(home,"help").getAbsolutePath();
	// public static final String helpFile_fr=new
	// File(helpDir_fr,"index.html").getAbsolutePath();
	// public static final String helpFile_en=new
	// File(helpDir_en,"index.html").getAbsolutePath();
	// public static final String helpImageDir_fr= new
	// File(helpDir_fr,"img").getAbsolutePath();
	// public static final String helpImageDir_en= new
	// File(helpDir_en,"img").getAbsolutePath();
	// public static final String legend_HydrauConfig_fr= new
	// File(helpImageDir_fr,"Legend_HydrauConfig.png").getAbsolutePath();
	// public static final String legend_HydrauConfig_en= new
	// File(helpImageDir_en,"Legend_HydrauConfig.png").getAbsolutePath();
	// public static final String legend_Gauging_fr= new
	// File(helpImageDir_fr,"Legend_Gaugings.png").getAbsolutePath();
	// public static final String legend_Gauging_en= new
	// File(helpImageDir_en,"Legend_Gaugings.png").getAbsolutePath();
	// public static final String legend_RC_fr= new
	// File(helpImageDir_fr,"Legend_RC.png").getAbsolutePath();
	// public static final String legend_RC_en= new
	// File(helpImageDir_en,"Legend_RC.png").getAbsolutePath();
	// public static final String legend_Limni_fr= new
	// File(helpImageDir_fr,"Legend_Limni.png").getAbsolutePath();
	// public static final String legend_Limni_en= new
	// File(helpImageDir_en,"Legend_Limni.png").getAbsolutePath();
	// public static final String legend_Hydro_fr= new
	// File(helpImageDir_fr,"Legend_Hydro.png").getAbsolutePath();
	// public static final String legend_Hydro_en= new
	// File(helpImageDir_en,"Legend_Hydro.png").getAbsolutePath();
