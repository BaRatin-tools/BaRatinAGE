...
public class ConfigControl {
	...
	private void writeData(GaugingSet gaugings) throws IOException {
		...
		if (gaugings == null) {
			...
			for (int i = 0; i < ntot; i++) {
				if (gaugings.getGaugings().get(i).getActive()) {
					nobs = nobs + 1;
				}
			}
		}
		...
		FileWriter fw = new FileWriter(f.getAbsoluteFile());
		BufferedWriter bw = new BufferedWriter(fw);
		bw.write("'" + Defaults.config_XYBAD.trim() + "'");
		bw.newLine();
		bw.write("1");
		bw.newLine();
		bw.write(Integer.toString(nobs));
		bw.newLine();
		bw.write("4");
		bw.newLine();
		bw.write("1");
		...
		bw.write("H[m] sigmaH[m] Q[m3/s] sigmaQ[m3/s]");
		bw.newLine();
	...
	private void writeRatingCurve(ConfigHydrau hydrau) throws IOException {
		...
		bw.write("RC_General");
		bw.newLine();
		bw.write(Integer.toString(3 * hydrau.getControls().size()));
		bw.newLine();
		...
		fw = new FileWriter(f.getAbsoluteFile());
		bw = new BufferedWriter(fw);
		bw.write(hydrau.getPriorRCoptions().toString());
		bw.newLine();
		bw.write(".true.");
		bw.newLine();
		bw.write(Defaults.results_PriorRC_spag);
		bw.newLine();
		bw.write(".true.");
		bw.newLine();
		bw.write(Defaults.results_PriorRC_env);
		bw.newLine();
		bw.close();
	}
	...
	private void writeMCMC(MCMCoptions mcmc) throws IOException {
		...
		bw.write(".true.");
		bw.newLine();
		bw.write("'" + mcmc.getFilename().trim() + "'");
		bw.newLine();
		bw.close();
	}
	...
	private void writePostProcessing(RatingCurve rc) throws IOException {
		...
		FileWriter fw = new FileWriter(f.getAbsoluteFile());
		BufferedWriter bw = new BufferedWriter(fw);
		bw.write("**** Cooked MCMC runs ****");
		bw.newLine();
		bw.write(".true.");
		bw.newLine();
		bw.write(Defaults.results_CookedMCMC);
		bw.newLine();
		bw.write("**** Summary of MCMC runs ****");
		bw.newLine();
		bw.write(".true.");
		bw.newLine();
		bw.write(Defaults.results_SummaryMCMC);
		bw.newLine();
		bw.write("**** Summary of H-Q gauging data ****");
		bw.newLine();
		bw.write(".true.");
		bw.newLine();
		bw.write(Defaults.results_SummaryGaugings);
		bw.newLine();
		bw.write("**** Rating Curve ****");
		bw.newLine();
		bw.write(rc.getPostRCoptions().toString());
		bw.newLine();
		bw.write(".true.");
		bw.newLine();
		bw.write(Defaults.results_PostRC_spag);
		bw.newLine();
		bw.write(".true.");
		bw.newLine();
		bw.write(Defaults.results_PostRC_env);
		bw.newLine();
		bw.write("2");
		bw.newLine();
		bw.write("1,0");
	...
	private void writeH2Q(Limnigraph limni, Hydrograph hydro) throws IOException {
		...
		FileWriter fw = new FileWriter(f.getAbsoluteFile());
		BufferedWriter bw = new BufferedWriter(fw);
		bw.write("'" + Defaults.config_HHBAD.trim() + "'");
		bw.newLine();
		bw.write(".true.");
		bw.newLine();
		bw.write(Defaults.results_Qt_spag);
		bw.newLine();
		bw.write(".true.");
		bw.newLine();
		bw.write(Defaults.results_Qt_env);
		bw.newLine();
		bw.write("3");
		bw.newLine();
		bw.write("1,0,0");
		...
		fw = new FileWriter(f.getAbsoluteFile());
		bw = new BufferedWriter(fw);
		bw.write("H  Hstd  Hbias_indx  Hbias");
		bw.newLine();
