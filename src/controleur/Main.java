...
public class Main {
	...
	public static String[] parseRow(String row, String sep) {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (conf.getLookAndFeel().equals("OS")) {
				UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
			} else {
				for (LookAndFeelInfo info : UIManager.getInstalledLookAndFeels()) {
					if (conf.getLookAndFeel().equals(info.getName())) {
		...
		;// leave to default look-and-feel
			// Run the GUI
