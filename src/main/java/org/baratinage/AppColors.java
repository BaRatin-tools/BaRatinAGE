...
public class AppColors {
    public final Color INVALID_DISABLED_BG = new Color(245, 230, 230);
    public final Color INVALID_BG = new Color(245, 210, 210);
    public final Color INVALID_FG = new Color(200, 50, 40);
    public final Color DANGER = INVALID_FG;
