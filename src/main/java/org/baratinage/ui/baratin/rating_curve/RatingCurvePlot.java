...
public class RatingCurvePlot extends RowColPanel {
        ...
        public void updatePlot(
                ...
                if (!isPrior && dischargeTotalUncertainty != null) {
                        Color totalColor = isPriorPlot ? null : AppSetup.COLORS.RATING_CURVE_TOTAL_UNCERTAINTY;
                        addPlotItemToPlot(
                                        plot,
                ...
                Color paramColor = isPriorPlot ? AppSetup.COLORS.PRIOR_ENVELOP
                ...
                Color mpColor = isPriorPlot ? AppSetup.COLORS.PRIOR_LINE : AppSetup.COLORS.RATING_CURVE;
