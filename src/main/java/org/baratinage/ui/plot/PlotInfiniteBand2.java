...
public class PlotInfiniteBand2 extends PlotItem {
    ...
    public PlotInfiniteBand2(String label, double coeffDir, double offsetLow, double offsetHigh, Paint fillPaint,
            float alpha) {
