...
public class MenuBar extends Custom_MenuBar{
	...
	private static final String[] RatingCurve_IDs={"AddRC","DeleteRC","RenameRC","DuplicateRC","ExportRC"};
	private static final String[] RatingCurve_names={"Add","Delete","Rename","Duplicate","ExportValues"};
