...
/**
 * GridBag_TextArea_Titled, a derived JTextArea type.
...
public class GridBag_TextArea_Titled extends JTextArea {
	 ...
	 */
	public GridBag_TextArea_Titled(
		...
		this.setBorder(BorderFactory.createTitledBorder(null, title, 
				SwingConstants.CENTER, SwingConstants.LEFT,titleFont,titleColor));
