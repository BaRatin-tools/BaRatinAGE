...
public class Line {
    ...
    public Line(String label, double[] x, double[] y, Paint paint, int lineWidth) {
        this(label, x, y, paint, lineWidth, null, 0);
    }

    public Line(String label, double[] x, double[] y, Paint paint, int lineWidth, SHAPE shape, int shapeSize) {
